...
const Login = () => {
  ...
  return (
    <>
    <section className="bg-cream min-h-screen flex box-border justify-center items-center">
    <div className="bg-cream border-black border-2 rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8">
            ...
            <div action="" className="flex flex-col gap-4">
                ...
                <div className="relative">
                    <input className="p-2 rounded-xl border w-full" onChange={(e)=>setPassword(e.target.value)} type="password" name="password" id="password" placeholder="Password"/>
                ...
                <button onClick={handleSubmit} className="bg-primary text-white py-2 rounded-xl hover:scale-105 duration-300 hover:bg-[#206ab1] font-medium" type='button'>Login</button>
            </div>
            ...
            <div className="mt-4 text-sm flex justify-between items-center container-mr">
               ...
               <NavLink to={'/register'} className="hover:border register text-white bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">Register </NavLink>
            </div>
        </div>
